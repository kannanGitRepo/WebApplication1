 ...
 * @author kannan
 */
@WebServlet(name = "ViewContribution", urlPatterns = {"/ViewContribution"})
public class ViewContribution extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       HttpSession session=request.getSession(false);  
		...
		"{call common_dml.user_contribution(?, ?, ?, ?)}");
             ...
             out.println("<tr><th>Transaction ID</th><th>Purchasing Date</th><th>Purpose</th><th>Description(if any)</th><th>Price</th><th>Update</th><th>Delete</th><tr>");
                while (rset.next()) {
                    ...
                    String update="<a href=\"update.jsp?id="+rset.getInt(1)+">Update</a>";
                    String delete="<a href=\"delete.jsp?id="+rset.getInt(1)+">Delete</a>";
                    float price=rset.getFloat(5);
             out.println("<tr><td>" + transId + "</td><td>"+ datePurchased + "</td><td>" + purpose+ "</td><td>" + description + "</td><td>" + price + "</td><td>" +  "<a href=\"update.jsp?id="+rset.getInt(1)+">Update</a>" + "</td><td>" + "<a href=\"delete.jsp?id="+rset.getInt(1)+">Delete</a>" + "</td></tr>" ) ;              
                }
                out.println("</table>");
